...
import static org.mockito.Mockito.*;    //we imported statically iot use verify(), times(), atMost() methods directly
...
class UserServiceImplTest {
    ...
    void deleteByUsername_test() {
        ...
        userService.deleteByUserName("mikesmith@cydeo.com");    //this is the test

        verify(userRepository).deleteByUserName("mikesmith@cydeo.com");
//        verify(userRepository, times(2)).deleteByUserName("mikesmith@cydeo.com"); //run same method 2 times
