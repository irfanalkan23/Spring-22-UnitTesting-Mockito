...
class ProjectServiceImplTest {
    ...
    void getByProjectCode_test() {
        ...
        // When
        ProjectDTO projectDTO1 = projectService.getByProjectCode(anyString());  //real test of the method is here

        // Then
        verify(projectRepository).findByProjectCode(anyString());
        verify(projectMapper).convertToDto(any(Project.class));     //we can use "project" as well instead of any(Project.class)

        assertNotNull(projectDTO1);     //this is from JUnit5 (Jupiter)
